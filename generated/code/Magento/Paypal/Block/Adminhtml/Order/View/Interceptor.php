...
class Interceptor extends \Magento\Paypal\Block\Adminhtml\Order\View implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function canAuthorize(\Magento\Sales\Model\Order $order) : bool
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canAuthorize');
        return $pluginInfo ? $this->___callPlugins('canAuthorize', func_get_args(), $pluginInfo) : parent::canAuthorize($order);
    }
    ...
    public function getUrl($params = '', $params2 = [])
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getUrl', func_get_args(), $pluginInfo) : parent::getUrl($params, $params2);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCancelUrl');
        return $pluginInfo ? $this->___callPlugins('getCancelUrl', func_get_args(), $pluginInfo) : parent::getCancelUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInvoiceUrl');
        return $pluginInfo ? $this->___callPlugins('getInvoiceUrl', func_get_args(), $pluginInfo) : parent::getInvoiceUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCreditmemoUrl');
        return $pluginInfo ? $this->___callPlugins('getCreditmemoUrl', func_get_args(), $pluginInfo) : parent::getCreditmemoUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getHoldUrl');
        return $pluginInfo ? $this->___callPlugins('getHoldUrl', func_get_args(), $pluginInfo) : parent::getHoldUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getUnholdUrl');
        return $pluginInfo ? $this->___callPlugins('getUnholdUrl', func_get_args(), $pluginInfo) : parent::getUnholdUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShipUrl');
        return $pluginInfo ? $this->___callPlugins('getShipUrl', func_get_args(), $pluginInfo) : parent::getShipUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCommentUrl');
        return $pluginInfo ? $this->___callPlugins('getCommentUrl', func_get_args(), $pluginInfo) : parent::getCommentUrl();
    }
    ...
    public function getReorderUrl()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getReorderUrl', func_get_args(), $pluginInfo) : parent::getReorderUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getVoidPaymentUrl');
        return $pluginInfo ? $this->___callPlugins('getVoidPaymentUrl', func_get_args(), $pluginInfo) : parent::getVoidPaymentUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getReviewPaymentUrl');
        return $pluginInfo ? $this->___callPlugins('getReviewPaymentUrl', func_get_args(), $pluginInfo) : parent::getReviewPaymentUrl($action);
    }
