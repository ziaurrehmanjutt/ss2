<?php
namespace Magento\Catalog\Block\Product\View\Details;

/**
 * Interceptor class for @see \Magento\Catalog\Block\Product\View\Details
 */
class Interceptor extends \Magento\Catalog\Block\Product\View\Details implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getGroupSortedChildNames');
        return $pluginInfo ? $this->___callPlugins('getGroupSortedChildNames', func_get_args(), $pluginInfo) : parent::getGroupSortedChildNames($groupName, $callback);
    }
