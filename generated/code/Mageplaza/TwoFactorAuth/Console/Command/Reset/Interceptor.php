<?php
namespace Mageplaza\TwoFactorAuth\Console\Command\Reset;

/**
 * Interceptor class for @see \Mageplaza\TwoFactorAuth\Console\Command\Reset
 */
class Interceptor extends \Mageplaza\TwoFactorAuth\Console\Command\Reset implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\User\Model\UserFactory $userFactory, $name = null)
    {
        $this->___init();
        parent::__construct($userFactory, $name);
    }
