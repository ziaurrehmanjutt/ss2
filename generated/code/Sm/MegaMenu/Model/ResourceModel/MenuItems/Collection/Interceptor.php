<?php
namespace Sm\MegaMenu\Model\ResourceModel\MenuItems\Collection;

/**
 * Interceptor class for @see \Sm\MegaMenu\Model\ResourceModel\MenuItems\Collection
 */
class Interceptor extends \Sm\MegaMenu\Model\ResourceModel\MenuItems\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNodesByGroupId');
        return $pluginInfo ? $this->___callPlugins('getNodesByGroupId', func_get_args(), $pluginInfo) : parent::getNodesByGroupId($prefix, $groupId);
    }
    ...
    public function getChildrenItems($depth_child_directly, $parent_id, $groupId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getChildrenItems', func_get_args(), $pluginInfo) : parent::getChildrenItems($depth_child_directly, $parent_id, $groupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsByGroupId');
        return $pluginInfo ? $this->___callPlugins('getItemsByGroupId', func_get_args(), $pluginInfo) : parent::getItemsByGroupId($groupId, $level_start);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsByLv');
        return $pluginInfo ? $this->___callPlugins('getItemsByLv', func_get_args(), $pluginInfo) : parent::getItemsByLv($groupId, $level_start, $status_child);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllItemsFirstByGroupId');
        return $pluginInfo ? $this->___callPlugins('getAllItemsFirstByGroupId', func_get_args(), $pluginInfo) : parent::getAllItemsFirstByGroupId($tableName, $groupId, $level_start, $status_child);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllActivedItems');
        return $pluginInfo ? $this->___callPlugins('getAllActivedItems', func_get_args(), $pluginInfo) : parent::getAllActivedItems($statusChild, $type, $itemId, $groupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDeleteItemsByGroup');
        return $pluginInfo ? $this->___callPlugins('getDeleteItemsByGroup', func_get_args(), $pluginInfo) : parent::getDeleteItemsByGroup($tableName, $groupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPrioritiesParent');
        return $pluginInfo ? $this->___callPlugins('getPrioritiesParent', func_get_args(), $pluginInfo) : parent::getPrioritiesParent($orderItem, $groupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllItemsByItemsId');
        return $pluginInfo ? $this->___callPlugins('getAllItemsByItemsId', func_get_args(), $pluginInfo) : parent::getAllItemsByItemsId($parentId, $groupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllItemsByItemsIdEnabled');
        return $pluginInfo ? $this->___callPlugins('getAllItemsByItemsIdEnabled', func_get_args(), $pluginInfo) : parent::getAllItemsByItemsIdEnabled($parentId, $groupId, $status_child);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllItemsMinusItemsId');
        return $pluginInfo ? $this->___callPlugins('getAllItemsMinusItemsId', func_get_args(), $pluginInfo) : parent::getAllItemsMinusItemsId($id, $parentId, $groupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setPrioritiesByNewItems');
        return $pluginInfo ? $this->___callPlugins('setPrioritiesByNewItems', func_get_args(), $pluginInfo) : parent::setPrioritiesByNewItems($tableName, $id, $allItems, $groupId, $prioritiesOrder);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getChidrenItemsByItems');
        return $pluginInfo ? $this->___callPlugins('getChidrenItemsByItems', func_get_args(), $pluginInfo) : parent::getChidrenItemsByItems($id, $groupId);
    }
    ...
    public function deleteItems($tableName, $id, $groupId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('deleteItems', func_get_args(), $pluginInfo) : parent::deleteItems($tableName, $id, $groupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setEnableAll');
        return $pluginInfo ? $this->___callPlugins('setEnableAll', func_get_args(), $pluginInfo) : parent::setEnableAll($mainTable, $groupId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDisableAll');
        return $pluginInfo ? $this->___callPlugins('setDisableAll', func_get_args(), $pluginInfo) : parent::setDisableAll($mainTable, $groupId);
    }
