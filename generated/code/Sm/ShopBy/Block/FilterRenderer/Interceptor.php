...
class Interceptor extends \Sm\ShopBy\Block\FilterRenderer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPriceRange');
        return $pluginInfo ? $this->___callPlugins('getPriceRange', func_get_args(), $pluginInfo) : parent::getPriceRange($filter);
    }
    ...
    public function getFilterUrl($filter)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getFilterUrl', func_get_args(), $pluginInfo) : parent::getFilterUrl($filter);
    }
